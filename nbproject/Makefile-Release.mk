...
${OBJECTDIR}/_ext/2048919765/colourCalc.o: ../Ambify/colourCalc.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2048919765/colourCalc.o ../Ambify/colourCalc.c

${OBJECTDIR}/_ext/2048919765/discovery.o: ../Ambify/discovery.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/2048919765
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2048919765/discovery.o ../Ambify/discovery.c

${OBJECTDIR}/_ext/2048919765/main.o: ../Ambify/main.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/2048919765
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/2048919765/main.o ../Ambify/main.c
